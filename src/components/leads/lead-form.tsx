...
export function LeadForm({
  ...
  const unitsRes = useResource<Paginated<Unit> | null>(unitsFetcher, [
    open,
    projectId,
  ]);
  ...
  return (
    <>
      <Dialog
        ...
        description={
          isEdit
            ? "Actualiza los datos, la etapa o el estado del lead."
            : "Registra un contacto que llegó por fuera de WhatsApp."
        }
        footer={
          <>
            <Button
